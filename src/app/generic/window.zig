...
pub const GenericWindow = struct {
    ...
    pub const Virtual = interface.VirtualTable(struct {
        ...
        reshapeWindow: fn (self: *Self, x: i32, y: i32, width: i32, height: i32) void,
        getFullscreenInfo: fn (self: *const Self, x: ?*i32, y: ?*i32, width: ?*i32, height: ?*i32) void,
        moveWindowTo: fn (self: *Self, x: i32, y: i32) void,
        bringToFront: fn (self: *Self, force: bool) void,
        forceToFront: fn (self: *Self) void,
        cleanup: fn (self: *Self) void,
        minimise: fn (self: *Self) void,
        maximise: fn (self: *Self) void,
        restore: fn (self: *Self) void,
        show: fn (self: *Self) void,
        hide: fn (self: *Self) void,
        setWindowMode: fn (self: *Self, new_mode: WindowMode) void,
        getWindowMode: fn (self: *const Self) WindowMode,
        isMaximised: fn (self: *const Self) bool,
        isMinimised: fn (self: *const Self) bool,
        isVisible: fn (self: *const Self) bool,
        getRestoredDimensions: fn (self: *Self, x: ?*i32, y: ?*i32, width: ?*i32, height: ?*i32) bool,
        ...
        getOsWindowHandle: fn (self: *const Self) ?*void,
        isForegroundWindow: fn (self: *const Self) bool,
        isFullscreenSupported: fn (self: *const Self) bool,
        setText: fn (self: *Self, text: []const u8) void,
        getDefinition: fn (self: *const Self) *const GenericWindowDefinition,
        adjustCachedSize: fn (self: *Self, size: *math.Vector2(f32)) void,
        getDpiScaleFactor: fn (self: *const Self) f32,
        setDpiScaleFactor: fn (self: *Self, dpi_scale_factor: f32) void,
        isManualManageDpiChanges: fn (self: *const Self) bool,
        setManualManageDpiChanges: fn (self: *Self, manual_manage_dpi_changes: bool) void,
        drawAttention: fn (self: *Self, parameters: *const WindowDrawAttentionParameters) void,
        setNativeWindowButtonsVisibility: fn (self: *Self, visible: bool) void,
    });
